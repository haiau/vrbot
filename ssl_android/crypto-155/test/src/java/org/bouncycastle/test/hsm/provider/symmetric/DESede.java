...
public final class DESede
{
  ...
  /**
        ...
        extends HSMBaseKeyGenerator
    {
        ...
        protected SecretKey engineGenerateKey()
        {
            ...
            if (!keySizeSet)
            {
                ...
                return new HSMSecretKeySpec(k, algName);
            }
            else
            {
    ...
    static public class KeyFactory
        extends HSMBaseSecretKeyFactory
    {
        public KeyFactory()
        {
            super("DESede", null);
        ...
        throws InvalidKeySpecException
        {
            if (keySpec instanceof DESedeKeySpec)
            {
                ...
                return new HSMSecretKeySpec(desKeySpec.getKey(), "DESede");
            }
    ...
    {
        private static final String PREFIX = org.bouncycastle.test.hsm.provider.symmetric.DESede.class.getName();
        private static final String PACKAGE = "org.bouncycastle.test.hsm.provider.symmetric"; // JDK 1.2
