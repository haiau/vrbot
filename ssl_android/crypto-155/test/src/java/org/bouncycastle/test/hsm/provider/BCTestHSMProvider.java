 ...
 */
public final class BCTestHSMProvider extends Provider implements ConfigurableProvider {
    private static String info = "Test HSM BouncyCastle Security Provider v0.01";

    public static final String PROVIDER_NAME = "TEST-BCHSM";

    public static final ProviderConfiguration CONFIGURATION = new TestHSMBouncyCastleProviderConfiguration();
     ...
     */
    private static final String SYMMETRIC_PACKAGE = "org.bouncycastle.test.hsm.provider.symmetric.";
...
//            };
    ...
    */
    private static final String ASYMMETRIC_PACKAGE = "org.bouncycastle.test.hsm.provider.asymmetric.";
...
//            };
    ...
    private static final String[] ASYMMETRIC_CIPHERS =
            {
                     "RSA" // "DSA", "DH", "EC", "GOST", "ECGOST", "ElGamal", "DSTU4145"
            };
...
//        put("Alg.Alias.CertStore.X509LDAP", "LDAP");
    ...
    private void loadAlgorithms(String packageName, String[] names)
    {
        ...
        {
            String name = packageName + names[i] + "$Mappings";
            ...
            if (clazz != null)
            {
                ...
                throw new RuntimeException("Provider Init: Could not find: "+name);
            }
        }
    }
    ...
    public void setParameter(String parameterName, Object parameter)
    {
        ...
        {
            ((TestHSMBouncyCastleProviderConfiguration)CONFIGURATION).setParameter(parameterName, parameter);
        }
    }
