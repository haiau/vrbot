package org.bouncycastle.test.hsm.provider;


import org.bouncycastle.test.hsm.provider.BCTestHSMProvider;
...
public class HSMSigTest extends SimpleTest
{
    /**
    ...
    {
        MessageDigest sha1 = MessageDigest.getInstance("SHA1", "TEST-BCHSM");
        Cipher signer = Cipher.getInstance("RSA/ECB/PKCS1Padding", "TEST-BCHSM");
        ...
        Signature verifier = Signature.getInstance("SHA1WithRSA", "TEST-BCHSM");
    ...
    public void performTest()
        throws Exception
    {   
        Signature           sig = Signature.getInstance("SHA1WithRSAEncryption", "TEST-BCHSM");
        KeyPairGenerator    fact;
        KeyPair             keyPair;
        byte[]              data = { 1, 2, 3, 4, 5, 6, 7, 8, 9, 0 };

        fact = KeyPairGenerator.getInstance("RSA", "TEST-BCHSM");
        ...
        sig = Signature.getInstance("MD2WithRSAEncryption", "TEST-BCHSM");
        ...
        sig = Signature.getInstance("MD5WithRSAEncryption", "TEST-BCHSM");
        ...
        sig = Signature.getInstance("RIPEMD160WithRSAEncryption", "TEST-BCHSM");
        ...
        // RIPEMD-128
        //
        sig = Signature.getInstance("RIPEMD128WithRSAEncryption", "TEST-BCHSM");
        ...
        // RIPEMD256
        //
        sig = Signature.getInstance("RIPEMD256WithRSAEncryption", "TEST-BCHSM");
        ...
        // SHA-224
        //
        sig = Signature.getInstance("SHA224WithRSAEncryption", "TEST-BCHSM");
        ...
        // SHA-256
        //
        sig = Signature.getInstance("SHA256WithRSAEncryption", "TEST-BCHSM");
        ...
        // SHA-384
        //
        sig = Signature.getInstance("SHA384WithRSAEncryption", "TEST-BCHSM");
        ...
        // SHA-512
        //
        sig = Signature.getInstance("SHA512WithRSAEncryption", "TEST-BCHSM");
        ...
        // ISO Sigs.
        //
        sig = Signature.getInstance("MD5WithRSA/ISO9796-2", "TEST-BCHSM");
        ...
        sig = Signature.getInstance("SHA1WithRSA/ISO9796-2", "TEST-BCHSM");
        ...
        KeyFactory  f = KeyFactory.getInstance("RSA", "TEST-BCHSM");
        ...
        sig = Signature.getInstance("RIPEMD160WithRSA/ISO9796-2", "TEST-BCHSM");
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
        Signature sig;
        byte[] sigBytes;
        sig = Signature.getInstance(algorithm, "TEST-BCHSM");
        ...
        throws Exception
    {
        ...
        Signature signer = Signature.getInstance("SHA1withRSA/X9.31", "TEST-BCHSM");

        signer.initVerify(KeyFactory.getInstance("RSA", "TEST-BCHSM").generatePublic(rsaPublic));
        ...
        throws Exception
    {
        ...
        RSAPublicKeySpec rsaPublic = new RSAPublicKeySpec(n, e);
        Signature signer = Signature.getInstance("SHA224withRSA/X9.31", "TEST-BCHSM");
        ...
        throws Exception
    {
        ...
        PrivateKey privateKey = KeyFactory.getInstance("RSA", "TEST-BCHSM").generatePrivate(rsaPriv);
        PublicKey publicKey = KeyFactory.getInstance("RSA", "TEST-BCHSM").generatePublic(rsaPublic);
    ...
    private void doGenVerify(String algorithm, PrivateKey privateKey, PublicKey publicKey, byte[] msg, byte[] sig)
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
        Signature signer = Signature.getInstance(algorithm, "TEST-BCHSM");
    ...
    public static void main(
        String[]    args)
    {
        Security.addProvider(new BCTestHSMProvider());

        runTest(new HSMSigTest());
    }
}
