 ...
 */
public class HSMAESTest
        extends HSMBaseBlockCipherTest {
    ...
    private void test(
        ...
        in = Cipher.getInstance("AES/ECB/NoPadding", "TEST-BCHSM");
        out = Cipher.getInstance("AES/ECB/NoPadding", "TEST-BCHSM");
    ...
    private void eaxTest()
        ...
        in = Cipher.getInstance("AES/EAX/NoPadding", "TEST-BCHSM");
        out = Cipher.getInstance("AES/EAX/NoPadding", "TEST-BCHSM");
        ...
        try {
            in = Cipher.getInstance("AES/EAX/PKCS5Padding", "TEST-BCHSM");
    ...
    private void ccmTest()
        ...
        in = Cipher.getInstance("AES/CCM/NoPadding", "TEST-BCHSM");
        out = Cipher.getInstance("AES/CCM/NoPadding", "TEST-BCHSM");
        ...
        try {
            in = Cipher.getInstance("AES/CCM/PKCS5Padding", "TEST-BCHSM");
    ...
    private void gcmTest()
        ...
        in = Cipher.getInstance("AES/GCM/NoPadding", "TEST-BCHSM");
        out = Cipher.getInstance("AES/GCM/NoPadding", "TEST-BCHSM");
        ...
        try {
            in = Cipher.getInstance("AES/GCM/PKCS5Padding", "TEST-BCHSM");
    ...
    private void ocbTest()
        ...
        in = Cipher.getInstance("AES/OCB/NoPadding", "TEST-BCHSM");
        out = Cipher.getInstance("AES/OCB/NoPadding", "TEST-BCHSM");
        ...
        try {
            in = Cipher.getInstance("AES/OCB/PKCS5Padding", "TEST-BCHSM");
