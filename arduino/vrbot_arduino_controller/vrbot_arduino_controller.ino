// VRBOT ARDUINO CONTROLLER
// By Pham Nguyen Hai Au (October 2016)

// Base on Simple Motor Shield sketch By arduino.cc user "Krodal" (June 2012)
...
//            lcd.write("BR");
          ...
          case 'u':
            if (servo1_pos <= 95) {
              for  (int i=servo1_pos; i<=servo1_pos+5; i++) {
                servo_1.write(i);
                delay(50);
              }
          ...
          case 'l':
            if (servo2_pos <= 95) {
              for  (int i=servo2_pos; i<=servo2_pos+10; i++) {
                servo_2.write(i);
                delay(50);
              }
